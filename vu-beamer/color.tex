...
% Outer theme colors
\setbeamercolor{normal text}{fg=vuBlack}
\setbeamercolor{alerted text}{fg=vuOrange}
\setbeamercolor{example text}{fg=vuGreen}

\setbeamercolor*{structure}{fg=vuBlue}

\setbeamercolor*{decoration}{fg=vuWhite,bg=vuBlue}
...
\setbeamercolor{separation line}{bg=vuBlack}
...
\setbeamercolor{middle separation line foot}{parent=separation line,bg=vuWhite}
\setbeamercolor{lower separation line foot}{parent=separation line}

\setbeamercolor{titlelike}{parent=structure}

% Inner theme colors
\setbeamercolor{title block body}{fg=vuWhite,bg=vuBlack}
...
\setbeamercolor{item projected}{use=item,fg=vuWhite,bg=item.fg}
